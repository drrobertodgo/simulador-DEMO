...
const demoQuestions: Question[] = [
  {
    ...
    context: 'Un docente se niega a adaptar sus materiales para un alumno indígena de nuevo ingreso que presenta una barrera de aprendizaje (espectro autista leve) y que tiene otra lengua materna. El docente argumenta frente al director que, por el principio de "igualdad", todos los niños deben ser tratados y evaluados exactamente de la misma forma para no discriminar al resto del grupo.',
    text: '¿Qué principio normativo está vulnerando el docente y qué acción fundamentada debe implementar el director?',
    options: [
      { id: 'A', text: 'El principio de equidad; el director debe autorizar que el alumno sea evaluado con estándares de menor exigencia académica para evitar el rezago estadístico del grupo.' },
      { id: 'B', text: 'El principio de inclusión y equidad sustantiva; el director debe instruir y asesorar al docente para realizar ajustes razonables, respetando la diversidad lingüística y cognitiva.' },
      { id: 'C', text: 'El principio de interculturalidad; el director debe gestionar la transferencia inmediata del alumno a un plantel de Educación Indígena o a un CAM donde cuenten con especialistas.' }
    ],
    correctId: 'B',
    explanation: 'La Ley General de Educación y el Art. 3 Constitucional establecen que la educación debe ser inclusiva, equitativa e intercultural. "Igualdad" no es enseñar lo mismo a todos, sino garantizar el acceso al aprendizaje mediante "Ajustes Razonables", sin segregar a los estudiantes de los planteles regulares.',
    hack: 'Hack del Tutor AI: En reactivos de "Inclusión" y "Barreras para el Aprendizaje (BAP)", NUNCA elijas opciones que propongan bajar el nivel educativo (A) o transferir/segregar al alumno (C). La respuesta correcta siempre incluirá "Ajustes razonables" dentro del aula regular.'
  },
  {
    id: 2,
    area: 1,
    ...
    text: 'De acuerdo con el Acuerdo 17/05/25 (Prevención y erradicación de la Violencia Sexual), ¿qué falta normativa grave cometió la directora?',
    options: [
      { id: 'A', text: 'Omitió realizar una investigación exhaustiva y recabar testimonios escritos de los compañeros antes de citar a los padres del agresor.' },
      { id: 'B', text: 'Faltó a la normativa al no suspender definitivamente y dar de baja al alumno agresor antes de informar a las autoridades.' },
      { id: 'C', text: 'Revictimizó a la alumna al mediar el conflicto; debió brindar contención, separar preventivamente a los alumnos y notificar inmediatamente a la Procuraduría de Protección y Fiscalía.' }
    ],
    correctId: 'C',
    explanation: 'El Acuerdo 17/05/25 prohíbe terminantemente la "mediación" o "conciliación" en casos de violencia sexual. La función de la escuela no es investigar el delito ni hacer careos, sino brindar contención, separar a los involucrados (medida cautelar) y hacer la Notificación y Canalización a las autoridades competentes.',
    hack: 'Hack del Tutor AI: ¡Regla de oro de los Protocolos 2025! "La violencia sexual NO se media, se denuncia". Cualquier opción que sugiera llegar a acuerdos, mediar, o que la escuela "investigue" o "interrogue" en casos de abuso, es la TRAMPA. Busca siempre "Notificar a la autoridad competente".'
  },
  {
    id: 3,
    area: 1,
    type: 'Ordenamiento (Lineamientos CTE 2024)',
    context: 'Durante la apertura de la sesión del Consejo Técnico Escolar (CTE), el supervisor instruye al colectivo docente a utilizar las 4 horas de la reunión exclusivamente para llenar unos formatos de estadística de zona, argumentando que el diseño del "Programa Analítico" lo pueden hacer los maestros individualmente en sus casas.',
    text: 'Con base en los Lineamientos del CTE (Acuerdo 05/04/24), ¿cuál debe ser la postura del director ante esta instrucción?',
    options: [
      { id: 'A', text: 'Dialogar con el supervisor para reorientar la sesión, recordando que el CTE es el órgano para la toma de decisiones pedagógicas y el codiseño, no para cubrir exigencias administrativas.' },
      { id: 'B', text: 'Acatar la instrucción por principio de subordinación jerárquica hacia la supervisión, pero acordando que la próxima sesión sí se dedicará exclusivamente a lo pedagógico.' },
      { id: 'C', text: 'Dividir al colectivo docente en dos equipos: uno dedicado a llenar la estadística administrativa y otro al diseño del Programa Analítico, optimizando los tiempos.' }
    ],
    correctId: 'A',
    explanation: 'El Acuerdo 05/04/24 (Lineamientos del CTE) establece claramente que el CTE es el máximo órgano colegiado de decisión pedagógica. Las autoridades (incluyendo directores y supervisores) tienen prohibido usar este espacio para satisfacer requerimientos administrativos o carga burocrática, protegiendo así el tiempo para la reflexión y el codiseño.',
    hack: 'Hack del Tutor AI: En el contexto de la Nueva Escuela Mexicana, el tiempo del CTE es sagrado. Descarta de inmediato cualquier opción que "negocie", "divida" o "justifique" el uso del CTE para llenar formatos o atender carga administrativa.'
  }
];
...
export default function App() {
  ...
  // 🔴 DATOS DE CONTACTO PARA VENTA (Modifícalos con el número de tu nuevo chip)
  const numeroWhatsapp = "5215555555555"; 
  const mensajeVenta = "Hola! Acabo de hacer el Demo del Tutor USICAMM y me interesa adquirir la versión completa PRO con simulador ilimitado.";
        ...
        <div className="max-w-3xl w-full relative">
          ...
          <div className="text-center mb-12 mt-6">
            ...
            <p className="text-lg text-slate-500 max-w-xl mx-auto">
              Descubre la plataforma de preparación estratégica más efectiva para la promoción vertical 2026-2027.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="flex items-center text-sm font-semibold text-emerald-600 mt-auto">
                Iniciar Demo <ArrowRight size={16} className="ml-2 group-hover:translate-x-1 transition-transform" />
              </div>
            </button>
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-2 text-slate-400">Función Supervisión</h2>
      ...
      <div className="min-h-screen bg-slate-50 p-6 lg:p-12 font-sans text-slate-800 flex flex-col items-center">
        <div className="w-full max-w-5xl">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900">Selecciona el módulo Demo</h1>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">Área 1:<br/>Aspectos Normativos</h3>
              <p className="text-slate-500 text-sm mb-6 flex-grow">Constitución, LGE, Protocolos 2025 y Acuerdos de convivencia.</p>
              <div className="flex items-center justify-between w-full mt-auto">
                  <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded border border-emerald-200">3 Reactivos Premium</span>
            ...
            {[
              { id: 2, title: 'Gestión Escolar', desc: 'Supervisión (Zorrilla), CTE, Mejora Continua y Liderazgo.', icon: Settings2 },
              { id: 3, title: 'Vínculo con la Comunidad', desc: 'Entornos Seguros, Vida Saludable Comunitaria y Cultura de Paz.', icon: BookOpen }
            ].map((item) => (
              <button 
                key={item.id}
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-slate-400">Área {item.id}:<br/>{item.title}</h3>
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-6 font-sans">
        <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl text-center max-w-2xl w-full border border-slate-100">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">¡Demo Completada!</h2>
          <p className="text-lg text-slate-500 mb-8">
            Has experimentado el poder de la metodología basada en "Hacks" y retroalimentación inteligente.
          </p>
          
          <div className="bg-slate-50 rounded-3xl p-6 mb-8 border border-slate-200">
            <div className="text-sm font-semibold text-slate-400 uppercase tracking-widest mb-2">Tu resultado del Demo</div>
            <div className="text-5xl font-black text-emerald-600">{score}/3</div>
          </div>

          <div className="bg-emerald-50 rounded-3xl p-8 mb-8 border border-emerald-100 text-left">
            <h3 className="font-bold text-emerald-900 mb-3 text-lg">¿Listo para asegurar tu ascenso?</h3>
            <ul className="space-y-3 text-emerald-800 text-sm mb-6">
              <li className="flex items-start"><CheckCircle2 size={18} className="mr-2 text-emerald-600 shrink-0"/> Simulador <strong>infinito</strong> impulsado por Inteligencia Artificial.</li>
              <li className="flex items-start"><CheckCircle2 size={18} className="mr-2 text-emerald-600 shrink-0"/> Desbloqueo de las <strong>3 áreas</strong> (Normativa, Gestión, Comunidad).</li>
              <li className="flex items-start"><CheckCircle2 size={18} className="mr-2 text-emerald-600 shrink-0"/> Funciones Directivas y de Supervisión completas.</li>
              <li className="flex items-start"><CheckCircle2 size={18} className="mr-2 text-emerald-600 shrink-0"/> Bibliografía oficial actualizada a <strong>2026-2027</strong>.</li>
            </ul>

            <p className="font-semibold text-center text-slate-700 mb-6">Pide informes y adquiere tu acceso hoy mismo:</p>
            
            <div className="flex justify-center">
              <a 
                href={`https://wa.me/${numeroWhatsapp}?text=${encodeURIComponent(mensajeVenta)}`}
          ...
          <button onClick={resetTutor} className="text-slate-400 hover:text-slate-600 text-sm font-medium transition-colors">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="bg-white p-6 rounded-[2rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-100">
            <div className="flex items-center justify-between mb-6">
              <button onClick={() => setArea(null)} className="flex items-center text-sm font-semibold text-slate-400 hover:text-emerald-600 transition-colors">
                 <ChevronRight className="rotate-180 mr-1" size={16} /> Salir
              </button>
              <span className="bg-emerald-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">Demo</span>
            </div>
            ...
            <h3 className="text-xl font-bold text-slate-900">Aspectos Normativos</h3>
             ...
             {showFeedback ? (
               <div className="space-y-4 animate-fade-in">
                 <p className="text-sm text-slate-200 leading-relaxed bg-slate-800/50 p-4 rounded-2xl">
                   <strong className="text-white block mb-1">Fundamento Legal:</strong><br/>
          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 min-h-full flex flex-col relative">
            ...
            {showFeedback && (
              <div className="pt-6 border-t border-slate-100 flex justify-end animate-fade-in">
                ...
                >
                  {currentQuestionIndex === activeQuestions.length - 1 ? 'Finalizar Demo' : 'Siguiente Reactivo'} 
...
function LockIcon(props: any) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.size || 24} height={props.size || 24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round" className={props.className}>
